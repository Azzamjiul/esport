...
<html lang="en" class="no-focus">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('template') }}/css/codebase.min.css">
    ...
    <body>
                                    ...
                                    <table class="table table-borderless table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$209</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$989</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$874</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$437</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$475</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$894</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$574</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <span class="text-black">$729</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
        ...
        <!-- Page JS Code -->
        <script src="{{asset('js') }}/js/pages/be_pages_dashboard.min.js"></script>
    </body>
</html>