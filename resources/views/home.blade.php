					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1140, 'gridheight': 800, 'responsiveLevels': [4096,1200,992,500]}">
						<ul>
							<li class="slide-overlay" data-transition="fade">
								<img src="{{ asset('template') }}/img/slides/slide-one-page-1-1.jpg"  
									alt=""
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="{{ asset('template') }}/img/slides/slide-one-page-1-2.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="{{ asset('template') }}/img/slides/slide-one-page-1-3.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="{{ asset('template') }}/img/slides/slide-one-page-1-4.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="{{ asset('template') }}/img/slides/slide-one-page-1-5.jpg" alt=""></div>
								...
								<div class="tp-caption"
									...
									data-transform_idle="opacity:0.2;s:500;"><img src="{{ asset('template') }}/img/slides/slide-title-border.png" alt=""></div>
								...
								<div class="tp-caption"
									...
									data-y="center" data-voffset="['2','2','2','15']"><img src="{{ asset('template') }}/img/slides/slide-blue-line-big.png" alt=""></div>
							...
							<li class="slide-overlay" data-transition="fade">
								<img src="{{ asset('template') }}/img/slides/slide-bg-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
							...
							<li class="slide-overlay slide-overlay-dark" data-transition="fade">
								<img src="{{ asset('template') }}/img/slides/slide-bg-6.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
							...
							<li class="slide-overlay" data-transition="fade">
								<img src="{{ asset('template') }}/img/blank.gif"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="tp-caption"
									...
									data-start="1000"
									data-transform_in="x:[-300%];opacity:0;s:500;"
									data-transform_idle="opacity:0.2;s:500;" style="z-index: 5;"><img src="{{ asset('template') }}/img/slides/slide-title-border.png" alt=""></div>
